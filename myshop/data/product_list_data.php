...
$user_id=getUseridbyUsername($_SESSION['login'],$conn);
...
$sql = "SELECT `product_id`,`name`,`main_img`,`category_id`,`start_date`,status from product where created_by='".$user_id."'";
