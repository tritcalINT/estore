...
if (isset($_GET['action'])) {
    if ($_GET['action'] == 'update') {
        if (!empty($_GET['id'])) {
            ...
            $sql = "SELECT * FROM collection WHERE id='" . $brand_id . "'";
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="box-header">
                                <?php if ($brand_id != '') { ?>
                                    <h3 class="box-title">Update Collection</h3>
                                <?php } else { ?>
                            ...
                            <div class="box-body">
                                ...
                                <?php if ($brand_id != '') { ?>
                                    <form action="data/update_collection.php" class="templatemo-login-form" method="post" enctype="multipart/form-data" name="update_brand">
                                        <input type="hidden" name="id" value="<?php echo $brand_id; ?>">
                                    <?php } else { ?>
                                        <form action="data/register_collection.php" class="templatemo-login-form" method="post" enctype="multipart/form-data" name="registration_brandba">
                                        <?php } ?>
                                        <div class="row form-group">
                                            <div class="col-lg-12 col-md-12 form-group">
                                                <label>Collection Name :</label>
                                                <input type="text" class="form-control" id="brand_name" placeholder="Collection Name" name="brand_name" value="<?php echo $brand_name; ?>">
                                            </div>
                                        </div>
