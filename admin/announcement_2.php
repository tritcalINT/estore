                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if ($row['a2_status'] == '1') { ?><button type="button" id="btna2<?php echo $row['a2_id']; ?>" class="btn btn-block btn-danger" onclick="deactivateAnnouncment('<?php echo $row['a2_id']; ?>', 2);">Deactivate</button><?php } ?></td>              
                                        </tr>
