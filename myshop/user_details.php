				...
				<div class="row form-group">
					<div class="col-lg-6 col-md-6 form-group">                  
						<label>Username :</label>
                                                <input type="text" class="form-control" id="user_name" placeholder="Username" name="user_name" value="<?php echo $row['user_name']; ?>" disabled>                            
					</div>
                                     ...
                                     <div class="col-lg-6 col-md-6 form-group">
                                        <label>User Type</label>
                                          <input type="text" class="form-control" id="user_level" placeholder="User Level" name="user_level" value="<?php echo $row['user_type']; ?>" >                         
