            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-dark">
                ...
                <tr>
				  ...
				  <button type="submit" class="btn btn-block btn-warning" id="btnmlogin<?php echo $row['user_id'];?>">Login</button>
				  </form>
				  <?php } ?>
				  </td>
				  <?php } ?>
				  ...
				  <?php if($_SESSION['master'] != '' || $_SESSION['admin'] != '' || $_SESSION['supermaster'] != ''){ ?>
					  <td><button type="button" class="btn btn-block btn-success" onclick="location.href='members_add.php?action=update&m=<?php echo $row['user_id']; ?>&r=<?php echo $row['user_member_reference ']; ?>';">Update</button></td>
					  <td><?php if($row['user_status'] == '1'){ ?><button type="button" id="btnm<?php echo $row['user_id'];?>" class="btn btn-block btn-danger" onclick="deactivateRecord('<?php echo $row['user_id'];?>', 'm');">Deactivate</button><?php } ?></td>   
                  <?php } ?>				  
                </tr>
