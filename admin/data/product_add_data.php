...
if(isset($_GET['action'])) {
	if ($_GET['action'] == 'update') {
			...
			$pd_Main_img = $row['main_img'];
                        ...
                        $pd_color=$row['color'];
                        $pd_size=$row['size'];
                        $pd_manufacture_commission=$row['manufacture_commission'];
                        $pd_distributor_commission=$row['distributor_commission'];
                        $pd_re_sellerr_commission=$row['re_sellerr_commission'];
                        $pd_shopper_commission=$row['shopper_commission'];
                        $pd_end_user_commission=$row['end_user_commission'];
