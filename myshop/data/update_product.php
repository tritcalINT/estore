<?php
	...
	$pd_id = $_POST['id'];
        ...
        $updated_by= getUseridbyUsername($_SESSION['login'], $conn);
...
//================================================================================================================
  ...
  if( $pd_short_description!= ''){
    ...
    //===========================================================================================================
        ...
        if($pd_related!= ''){
          $sql_update_product = "UPDATE product SET related= '".$pd_related."'   WHERE product_id = '".$pd_id."'" ;
...
//=================================================================================================================
 ...
 //=================================================================================================================
    ...
    if($fail == true){
         ...
         header('Location: ../product_add.php?action=update&pd='.$pd_id);
    }
    else{
