                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if ($row['a1_status'] == '1') { ?><button type="button" id="btna1<?php echo $row['a1_id']; ?>" class="btn btn-block btn-danger" onclick="deactivateAnnouncment('<?php echo $row['a1_id']; ?>', 1);">Deactivate</button><?php } ?></td>              
                                        </tr>
