      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-header">
              ...
              <div class="box-tools ">
                  <form action="brand_list.php" method="post" enctype="multipart/form-data" name="brand_list_search">
					<div class="col-lg-4 col-xs-4 ">                  
						<input type="text" name="search_brand" id="search_brand" class="form-control pull-right" placeholder="Brand" value="<?=$search_brand; ?>">                           
					</div>
					<div class="col-lg-4 col-xs-4 ">                  
            ...
            <div class="box-body table-responsive no-padding">
               <table class="table table-dark">
                ...
                <tr>
                  ...
                  <td><?php if($row['status'] == '1'){ ?><button type="button" id="btnln<?php echo $row['id'];?>" class="btn btn-block btn-danger" onclick="deactivateRecord('<?php echo $row['id'];?>', 'id');">Deactivate</button><?php } ?></td>              
                </tr>
