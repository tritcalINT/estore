      ...
      <div class="row">
		...
		<?php if($error != '') { ?>
            ...
            if($brand_id != ''){ ?>
                ...
                <input type="hidden" name="user_cat_id" value="<?php echo $user_cat_id; ?>">
            <?php } else { ?>
            ...
            <?php } ?>
				...
				<div class="row form-group">
					<div class="col-lg-12 col-md-12 form-group">
						...
						<input type="text" class="form-control" id="user_cat_name" placeholder="User Level name" name="user_cat_name" value="<?php echo $user_ref_link; ?>">
					</div>
				</div>
				...
				<div class="row form-group">
			      ...
			      <select class="form-control" name="user_cat_level" id="user_cat_level">
					...
					<div class="col-lg-4 col-md-4 form-group">
						...
						<input type="text" class="form-control" id="user_cat_ref_per" placeholder="Commission" name="user_cat_ref_per" value="<?php echo $user_cat_ref_per; ?>">
					</div>
              
                                    <div class="col-lg-4 col-md-4 form-group">
						<label>parent User Type :</label>
						<input type="text" class="form-control" id="user_cat_main" placeholder="Parent User Type" name="user_cat_main" value="<?php echo $user_cat_main; ?>">
					</div>
				</div>
