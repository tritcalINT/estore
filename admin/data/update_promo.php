...
if ($p_title != '' && $p_date != '' && $p_description != '') {
    $sql = "UPDATE promotion SET p_title = '" . $p_title . "', p_date = '" . $p_date . "', p_description = '" . $p_description . "', p_status = '" . $p_status . "', p_created_by = '" . $update_by_id . "' " . $sql_pic . " WHERE p_id = '" . $p_id . "'";
//            echo $sql;
//            exit();
//            
