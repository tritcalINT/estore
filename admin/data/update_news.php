...
if ($ln_title != '' && $ln_date != '' && $ln_description != '') {
    if ($newfilename != null) {
        ...
        $sql = "UPDATE latest_news SET ln_title = '" . $ln_title . "', ln_date = '" . $ln_date . "', ln_description = '" . $ln_description . "', ln_status = '" . $ln_status . "', ln_created_by = '" . $update_by_id . "' WHERE ln_id = '" . $ln_id . "'";
    }
