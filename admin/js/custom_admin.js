...
function deactivateNews(id) {
    if (id != '') {
        if (confirm("Are you sure you want to  Deactivate?"))
        {
            window.location.href = "../admin/data/deactivateNews.php?id=" + id;
        } else {
            alart('Cancal Action');
            window.location.href = "../admin/news_list.php";
        }
    }
}
function deactivateBrands(id) {
    if (id != '') {
        if (confirm("Are you sure you want to  Deactivate?"))
        {
            window.location.href = "../admin/data/deactivateBrands.php?id=" + id;
        } else {
            alart('Cancal Action');
            window.location.href = "../admin/brand_list.php";
        }
    }
}
function deactivateCategory(id) {
    if (id != '') {
        if (confirm("Are you sure you want to  Deactivate?"))
        {
            window.location.href = "../admin/data/deactivate_cat.php?id=" + id;
        } else {
            alart('Cancal Action');
...
function deactivateAnnouncment(id, type = 1) {
    if (id != '') {
        if (confirm("Are you sure you want to  Deactivate?"))
        {
            window.location.href = "../admin/data/deacvtivate_announ.php?id=" + id + "&type=" + type;
        } else {
            alart('Cancal Action');
            if (type == 1) {
                window.location.href = "../admin/announcement_1.php";
            } else {
                window.location.href = "../admin/announcement_2.php";
            }
...
function deactivatePromo(id) {
    if (id != '') {
        if (confirm("Are you sure you want to  Deactivate?"))
        {
            window.location.href = "../admin/data/deativate_promo.php?id=" + id;
        } else {
            alart('Cancal Action');
            window.location.href = "../admin/promo_list.php";

        }
    }
}
function deactivateUserCat(id) {
    if (id != '') {
        if (confirm("Are you sure you want to  Deactivate?"))
        {
            window.location.href = "../admin/data/deactivateUserCat.php?id=" + id;
        } else {
            alart('Cancal Action');
            window.location.href = "../admin/user_cat_list.php";
        }
    }
}
function deactivateCollection(id) {
    if (id != '') {
        if (confirm("Are you sure you want to  Deactivate?"))
        {
            window.location.href = "../admin/data/deletecollection.php?id=" + id;

        } else {
            alart('Cancal Action');
            window.location.href = "../admin/collection_list.php";
        }
    }
}
