                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" value="<?php echo $sl_image_main; ?>" name="image_main">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" value="<?php echo $sl_image_sub_1; ?>" name="image_sub_1">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" value="<?php echo $sl_image_sub_2; ?>" name="image_sub_2">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-4">
                            <div class="upload_picture">
                                ...
                                <?php
                                if($action == 'update'){
                                    echo '<img src="../uploads/slides/'.$sl_image_sub_3.'"  id="img_sub_3" style="height:100px;width: 100px;background-color: #ccc;border: 3px solid white;">';
                                }
                                else{
                                    echo '<img src="../images/no-image.png" name="sl_image_sub_3" id="img_sub_3" style="height:100px;width: 100px;background-color: #ccc;border: 3px solid white;">';
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="file" name="sl_image_sub_3" class="form-control" id="image_sub_3" placeholder="Username" aria-describedby="inputGroupPrepend" style="display: none" >
                                            <input type="button" value="Browse" id="browse_image_sub_3" class="btn btn-info form-control">
                                            <input type="hidden" value="<?php echo $sl_image_sub_3; ?>" name="image_sub_3">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="upload_picture">
                                ...
                                <?php
                                if($action == 'update'){
                                    echo '<img src="../uploads/slides/'.$sl_image_sub_4.'" id="img_sub_4" style="height:100px;width: 100px;background-color: #ccc;border: 3px solid white;">';
                                }
                                else{
                                    echo '<img src="../images/no-image.png" id="img_sub_4" name="sl_image_sub_4" style="height:100px;width: 100px;background-color: #ccc;border: 3px solid white;">';
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="file" name="sl_image_sub_4" class="form-control" id="image_sub_4" placeholder="Username" aria-describedby="inputGroupPrepend" style="display: none" >
                                            <input type="button" value="Browse" id="browse_image_sub_4" class="btn btn-info form-control">
                                            <input type="hidden" value="<?php echo $sl_image_sub_4; ?>" name="image_sub_4">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$('#browse_image_sub_3').on('click', function(e){
    $('#image_sub_3').click();
})
$('#image_sub_3').on('change', function(e){
    var fileInput = this;
    if(fileInput.files[0]){
        var reader = new FileReader();
        reader.onload = function(e){
            $('#img_sub_3').attr('src', e.target.result);
        }
        reader.readAsDataURL(fileInput.files[0]);
    }
})
...
$('#browse_image_sub_4').on('click', function(e){
    $('#image_sub_4').click();
})
$('#image_sub_4').on('change', function(e){
    var fileInput = this;
    if(fileInput.files[0]){
        var reader = new FileReader();
        reader.onload = function(e){
            $('#img_sub_4').attr('src', e.target.result);
        }
        reader.readAsDataURL(fileInput.files[0]);
    }
})
