                                ...
                                <tbody class="white-color">
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if ($row['ln_status'] == '1') { ?><button type="button" id="btnln<?php echo $row['ln_id']; ?>" class="btn btn-block btn-danger" onclick="deactivateNews('<?php echo $row['ln_id']; ?>');">Deactivate</button><?php } ?></td>              
                                        </tr>
