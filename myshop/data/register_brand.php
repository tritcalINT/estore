<?php
	...
	//Fetching Values from URL
      ...
      // echo $brand_rank;
//         echo $brand_cat;//htmlentities($_POST['brand_cat_id'], ENT_QUOTES, "UTF-8");
//         echo $brand_description ;
//         echo  $brand_logo;
     // echo  htmlentities($_POST['rank'], ENT_QUOTES, "UTF-8");
      // exit();
	...
	if($fail == "1") {
	      header('Location: ../brand_add.php?error=2');	   
    } else {
		if($brand_name != '' ){
			
			$sql_brand = "INSERT INTO brands (name, category, rank,logo, des, status ) VALUES ('".$brand_name."', '".$brand_cat."', '".$brand_rank."', '".$newfilename."', '".$brand_description."','".$brand_status."')";
			...
			header('Location: ../brand_add.php?error=1');
		}
	}
