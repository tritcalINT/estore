...
if ($cat_title != '') {
    if ($newfilename != null) {
        $sql = "UPDATE categories SET sku = '" . $cat_sku . "',status='" . $cat_status . "', level = '" . $cat_level . "', main_cat = '" . $cat_main . "', name = '" . $cat_title . "', brand = '" . $cat_brand . "',logo='" . $newfilename . "'  WHERE  cat_id  = '" . $cat_id . "'";
    } else {
        $sql = "UPDATE categories SET sku = '" . $cat_sku . "',status='" . $cat_status . "', level = '" . $cat_level . "', main_cat = '" . $cat_main . "', name = '" . $cat_title . "', brand = '" . $cat_brand . "'  WHERE  cat_id  = '" . $cat_id . "'";
    }
