<?php
	...
	$ln_title = $_POST['promo_title'];
    $ln_date = $_POST['news_date'];
	$ln_description = $_POST['promo_description'];
	...
	if($fail == "1") {
	      header('Location: ../promo_add.php?error=2');
    } else {
		if($ln_title != '' && $ln_date != '' && $ln_description != ''){

			$sql = "INSERT INTO promotion (p_title, p_date, p_description, p_pic, p_status, p_created_by) VALUES ('".$ln_title."', '".$ln_date."', '".$ln_description."', '".$newfilename."', '".$ln_status."', '".$admin_id."')";
                        //echo $sql;
			...
			header('Location: ../promo_add.php?error=1');
		}
	}
