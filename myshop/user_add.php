	...
	<div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-6">
			...
			<?php
            if($m_id != ''){ ?>
                <form action="data/update_user.php" class="templatemo-login-form" method="post" enctype="multipart/form-data" name="update_user">
                <input type="hidden" name="id" value="<?php echo $user_id; ?>">
				<input type="hidden" name="referal" value="<?php echo $m_referal; ?>">
            <?php } else { ?>
                                <form action="data/register_new_user.php" class="templatemo-login-form" method="post" enctype="multipart/form-data" name="registration_members">
            <?php } ?>
