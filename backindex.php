                    ...
                    <ul>
                        <li data-transition="fade" data-slotamount="6" data-masterspeed="600" data-saveperformance="on"  data-title="Special Offers">
                            ...
                            <div class="tp-caption lfl ltl" data-x="center"  data-y="bottom"  data-hoffset="-230" data-speed="2000" data-start="500" data-endspeed="800">
                                <img src="images/homeslider/slide1_1.png" alt="Slide 1_1">
                            </div> 
                        </li>
        	...
        	<div class="container">
        	 ...
        	 <?php
                                                                            ...
                                                                            <div class="item item-hover">
                                                                                                ...
                                                                                                echo '<a href="'.$strdet.'"><div class="item"> <img  src="'. $row['img1']. '" alt="'.$itmnm.'" class="item-image">
                                                                                                
                                                                                                </div></a>';
                                                                                                
                                                                                                 echo '<a href="'.$strdet.'"><div class="item"> <img  src="'. $row['img2']. '" alt="'.$itmnm.'" alt="item1  Hover" class="item-image-hover">
