...
$pacctyp = intval(base64_decode($_GET['pacctyp']));
$pacctyp = 1;
...
<html>
<head>
<title><?php echo PG_HEAD; ?>  | Home :: Help Center </title>
...
<div class="women_main">
    <h2>Contact <span> <?php echo CO_NAME ?> </span></h2>
	<!-- start content -->
												...
												<div class="input-group">							
													<span class="input-group-addon">
														<i class="fa fa-phone-square"></i>
                                                                                                    ...
                                                                                                    <label class="form-control1"><?php echo CON_NO ?> </label>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">							
													...
													<label class="form-control1"><?php echo '<a href="mailto:'.CON_EMAIL.'">'.CON_EMAIL.'</a> '?>  </label>
												</div>
											</div>
										</div>
                                                                                <div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group">							
													...
													<label class="form-control1"><?php echo 'FB Link'?>  </label>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<div class="input-group input-icon right">
													...
													<label class="form-control1"><?php echo CO_NAME ?>  </label>
												</div>
											</div>
											<div class="col-sm-2">
												<p class="help-block">Company address</p>
											</div>
										</div>
