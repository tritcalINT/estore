...
{    
    ...
    $comnm = $database->getcomdetails($comky,"comnm");
}
?>
<!DOCTYPE HTML>
<html>
<head>
<title><?php echo PG_HEAD; ?>  | Home :: Order List </title>
									...
									<thead>
										...
										<tr>
											...
											<th width="50">Order #</th>
                                                                                        <th width="50">Placed On</th>
                                                                                        <th width="50">Total</th>
                                                                                        <th width="50">Payment Type</th>
                                                                                        <th width="50">Status</th>
                                                                                        <th width="60"class=''>Preview</th>
                                                                                        <th class='50'>Cancel</th>
											
										</tr>
									</thead>
									<tbody id="tbldoc">
                                                                        <?php $database->vieworderlist($usrky); ?>    
									</tbody>
								</table>
